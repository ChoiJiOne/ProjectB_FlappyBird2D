/**
 * @brief FlappyBird 게임 타이틀 슬레이트 UI입니다.
 */
class FlappyBirdSlate : Slate
{
    /**
     * @brief FlappyBird 게임 타이틀 슬레이트 UI 속성에 대한 Getter/Setter입니다.
     */
    public bool Movable
    {
        get => bCanMove_;
    ...
    /**
     * @brief FlappyBird 게임 타이틀 슬레이트 UI를 업데이트합니다.
     * 
    ...
    /**
     * @brief 타이틀 슬레이트 오브젝트가 움직일 수 있는지 확인합니다.
     */
    private bool bCanMove_ = true;


    /**
     * @brief 타이틀 슬레이트 오브젝트가 움직이는 방향입니다.
     * 
    ...
    /**
     * @brief 타이틀 슬레이트 오브젝트가 움직이기 위해 누적된 시간입니다.
     */
    private float waitTimeForMove_ = 0.0f;


    /**
     * @brief 타이틀 슬레이트 오브젝트가 움직이기 위해 기다릴 수 있는 최대 시간입니다.
     */
    private float maxWaitTimeForMove_ = 0.0f;


    /**
     * @brief 타이틀 슬레이트 오브젝트가 움직이는 거리입니다.
     */
