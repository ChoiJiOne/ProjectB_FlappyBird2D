...
void StartScene::Enter()
{
	...
	static RUID startButton = EntityManager::Get().Create<Button>("Resource/Button/Start.json", font32ID, EMouseButton::Left, 
		[&]() 
		{ 
			link_ = playScene_;
			bDetectSwitch_ = true;
	...
	static RUID settingButton = EntityManager::Get().Create<Button>("Resource/Button/Setting.json", font32ID, EMouseButton::Left, 
		[&]() 
		{ 
			link_ = settingScene_;
			bDetectSwitch_ = true;
